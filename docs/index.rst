.. Tabs documentation master file, created by
   sphinx-quickstart on Tue Jul 25 11:39:36 2017.
...
from the abstract class :code:`Table` that requires :code:`input`, `output` and
